							...
							<div class="account-content">
								<div class="row align-items-center justify-content-center">
									<div class="col-md-7 col-lg-6 login-left">
										<img src="resources/img/login-banner.png" class="img-fluid" alt="Login Banner">	
									</div>
									<div class="col-md-12 col-lg-6 login-right">
										...
										<form action="login.html">
											<div class="form-group form-focus">
												<label class="focus-label">아이디</label>
												<input type="text" class="form-control floating" placeholder="아이디">
												<label class="focus-label">이름</label>
												<input type="text" class="form-control floating" placeholder="이름">
												<label class="focus-label">생년월일</label>
												<input type="date" class="form-control floating" placeholder="ex)19980101">
												<label class="focus-label">핸드폰</label>
