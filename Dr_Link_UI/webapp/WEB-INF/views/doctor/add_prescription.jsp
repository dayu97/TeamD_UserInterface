							...
							<div class="account-content">
								...
								<div class="card-header text-center" style="border-bottom:0px !important; margin-top:10px !important;">
										...
										<div class="card-body">
											<div class="table-responsive">
												...
												<tbody>
													<tr>
														<td>
															<input class="form-control" value="바이모틴정5mg" type="text">
														</td>
														<td>
															<input class="form-control" type="text" value="2">
														</td>
														<td>
															<input class="form-control" value="2회" type="text">
														</td>
														<td>
															<input class="form-control" value="3일" type="text">
														</td>
														<td>
													...
													<tr>
														<td>
															<input class="form-control" value="후라시닐정" type="text">
														</td>
														<td>
									...
									<!-- /Prescription Item -->
											...
											<button type="submit" class="btn btn-info submit-btn" formaction="index">입력 완료</button>
